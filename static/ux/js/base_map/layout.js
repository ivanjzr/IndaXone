...
ExploreApp.Layout = Backbone.Marionette.Layout.extend({


    template: Handlebars.compile(G.templates.find('#explore-layout-template').html()),
    ...
    initialize: function(options){
        ...
        M.evtAgg.bind("load_place_content", this.load_place_content);
    ...
    on_zoom_in: function(e){
        M.evtAgg.trigger('zoom_in');
    },

    on_zoom_out: function(e){
        M.evtAgg.trigger('zoom_out');
    },
    ...
    on_restart: function(e){
        ...
        var loading_gif = G.paths.images_path + '/pc_1024x768' + "/loading_arrow.gif";
        ...
        setTimeout(function(){
            ...
            var loading_png = G.paths.images_path + '/pc_1024x768' + "/loading_arrow.png";
            var img_size = "width:32px;height:32px;";
    ...
    load_place_content: function(place_reference, on_complete){
        var self = this;
        M.evtAgg.trigger('load_place_details', place_reference, function(results){
            // start instances
    ...
    display_results_panel_data: function(options){
        ...
        this.ui.results_panel
            .animate({height:500},200, function(){
                ...
                var img_size = "width:32px;height:32px;";
                var img_loading = "<img src='" + G.paths.images_path + '/pc_1024x768' + img_name + "' style='" + img_size + "'>";
    ...
    // just execute callback on show
    onShow: function(){
        this.options.onAppReady();
    },
