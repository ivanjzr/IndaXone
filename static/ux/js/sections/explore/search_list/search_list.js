...
SearchList.ItemView = Backbone.Marionette.ItemView.extend({
    ...
    template: Handlebars.compile(G.templates.find('#search-list-item-template').html()),
    ...
    on_place_item_hover_on: function(ev){
        ...
        M.evtAgg.trigger('info_window_hover', ref_id);
    },
...
SearchList.View = Backbone.Marionette.CompositeView.extend({
    ...
    template: Handlebars.compile(G.templates.find('#search-list-grid-template').html()),
